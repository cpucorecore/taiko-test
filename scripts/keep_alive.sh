#set -x
pk=`your pk`
to=0xafF0CA253b97e54440965855cec0A8a2E2399896
rpc=http://localhost:28545
...
then
	...
	cast send --value 1 --priority-gas-price $priority_gas_price --gas-price $gas_price -r $rpc --private-key $pk $to
fi
